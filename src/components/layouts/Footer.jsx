                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
                    <div className="sm:col-span-2 lg:col-span-1">
                        ...
                        <p className="text-gray-400 leading-relaxed text-sm md:text-base">
                            Solusi Jasa Pembuatan Website Harga Terjangkau.
                        </p>
                    </div>

                    {/* Layanan */}
                    <div>
                        <h4 className="text-white font-semibold mb-4 text-base">Layanan</h4>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li>
                                <a
                                    href="https://wa.me/6281359001002"
                                    target="_blank"
                            ...
                            <li>
                                ...
                                >
                                    ...
                                    <span>0851-7411-6973</span>
                                </a>
                            </li>
                            <li>
                                <a
                                    href="https://www.instagram.com/averanteam.official"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-gray-400 hover:text-white transition-colors duration-200 flex items-center gap-2 group"
                                >
                                    ...
                                    <span>@averanteam.official</span>
                                </a>
                            </li>
                            <li>
                                <a
                                    href="mailto:averanteam44@gmail.com"
                                    className="text-gray-400 hover:text-white transition-colors duration-200 flex items-center gap-2 group"
                                >
                                    ...
                                    <span>averanteam44@gmail.com</span>
                                </a>
                            </li>
                        </ul>
